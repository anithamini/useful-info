...
os.system("adb push C://Users//galluri//Desktop//GM_Stability2//GM_Stability//media_audio //sdcard/movies/media/")
def mo_call_test():
    ...
    os.system("adb shell am start -a android.intent.action.CALL -d tel:9100071286")#6300246158
    time.sleep(5)
    ...
    with open("mCallState1.txt", "r+") as fh:
        ...
        for line in lines:
            ...
            if (string2 in line):
                ...
                os.system("adb shell am start -a android.intent.action.SENDTO -d sms:9100071290 --es sms_body 'Testing SMS!!!' --ez exit_on_sent true")
                time.sleep(5)
