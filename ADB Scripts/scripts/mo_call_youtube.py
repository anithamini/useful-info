    ...
    with open("mCallState1.txt", "r+") as fh:
        ...
        for line in lines:
            ...
            if (string2 in line):
                ...
                print("Ending the call \n")
                time.sleep(5)
                os.system("adb shell am start -a android.intent.action.VIEW -d 'https://youtu.be/CSULRDoF8-g'")
                print("Video play for 10 secs")
                time.sleep(11)
                os.system("adb shell am force-stop com.my.app.package")
                os.system("adb shell input keyevent KEYCODE_ENDCALL")
