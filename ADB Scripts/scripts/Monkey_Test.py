...
class Monkey_test:
    ...
    def monkey_test(self):
        ...
        os.system(
            "adb shell monkey -s 950 --throttle 500 -v --ignore-timeouts --ignore-crashes --ignore-security-exceptions  --kill-process-after-error --pct-trackball 12  --pct-touch 35 --pct-motion 10 --pct-nav 3 --pct-syskeys 5 --pct-appswitch 10 --pct-anyevent 1 --pct-flip 15 --pct-majornav 9 100  > monkey_console.txt ")
