    ...
    with open("mCallState1.txt", "r+") as fh:
        ...
        for line in lines:
            ...
            if (string2 in line):
                ...
                os.system("adb shell monkey -p in.amazon.mShop.android.shopping -c android.intent.category.LAUNCHER 1")
                print("Amazon app opened")
                time.sleep(3)
            ...
            print("Unable to connect the call, so test case is 9100071286")
            return 0
...
print ("Total NO.OF iterations 9100071290: %d" %fail_TC)
print ("---------------------------------")
